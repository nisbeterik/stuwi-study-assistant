...
```
cd existing_repo
git remote add origin https://git.chalmers.se/courses/dit113/2024/group-2/stuwi-study-assistant.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.chalmers.se/courses/dit113/2024/group-2/stuwi-study-assistant/-/settings/integrations)
